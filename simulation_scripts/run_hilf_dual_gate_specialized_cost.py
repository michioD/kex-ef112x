...
def run_hierarchical_inference_simulation(
    ...
    for t, img_path in enumerate(image_paths):
        ...
        cluster_only_accepts += int(accept_sml_cluster and not accept_sml_classification)
        ...
        with open(output_csv, "a", newline="") as f:
            writer = csv.writer(f)
            writer.writerow([t, p_t, q_t, s_t, q_t_cluster, action, Y_t, success, fp, fn, misclassified, accept_sml_classification, accept_sml_cluster])
    ...
    print(f"Weakest accepted, cluster rejected: {weakest_only_accepts}")
    print(f"Cluster accepted, weakest rejected: {cluster_only_accepts}")
